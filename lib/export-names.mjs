...
/**
 * Filename slugs for exports/ (site-specific or "all" for --all-properties).
 */
...
function longTailKindPrefix(opts) {
  if (opts.allProperties) {
    if (opts.source === "google") return "google-long-tail";
...
/**
 * e.g. google-long-tail-example-com or search-long-tail-all
 * @param {{ source: string; site?: string; bingSite?: string; allProperties?: boolean }} opts
 */
